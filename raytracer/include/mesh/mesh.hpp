...
namespace rt {
  ...
  public:
    ...
    H_CALLABLE CMesh(const std::vector<glm::vec3>& vbo, const std::vector<glm::uvec3>& ibo, const std::vector<glm::vec3>& normals, const std::vector<glm::vec2>& tcs, const glm::vec3& worldPos, const glm::vec3& normal);
    H_CALLABLE CMesh();
  ...
  private:
    ...
    H_CALLABLE static glm::mat4 getModelToWorldTransform(const glm::vec3& worldPos, const glm::vec3& normal);
  };
