...
namespace rt {
  ...
  public:
    ...
    H_CALLABLE std::tuple<std::vector<SAABB>, std::vector<SAABB>, glm::mat4x3> getObjectBBs(ESceneobjectMask mask = ESceneobjectMask::ALL) const; // returns modelBB and worldBB of first object with mask
  private:
