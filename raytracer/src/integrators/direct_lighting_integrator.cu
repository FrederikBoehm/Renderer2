      ...
      if (si.hitInformation.hit) {
        if (si.material) {
          if (si.material->Le() != glm::vec3(0.0f)) { // Hit on light source
            ...
            if (si2.hitInformation.hit && si2.material) {
              glm::vec3 Le = si2.material->Le();
          ...
          // Sample light source
          {
            ...
            if (lightPdf > 0.f && si2.material) {
              ...
              L += f * si2.material->Le() * tr * mis_weight / lightPdf;
          ...
          // Sample phase function
          {
            ...
            L += f * si2.material->Le() * tr * mis_weight / scatteringPdf;
            //L += tr.r > tr.g ? glm::vec3(1.f, 0.f, 0.0f) : glm::vec3(0.f);
